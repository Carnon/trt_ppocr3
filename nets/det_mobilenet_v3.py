...
class SEModule(nn.Module):
    def __init__(self, in_channels, reduction=4, name=""):
        ...
        self.conv1 = nn.Conv2d(in_channels=in_channels, out_channels=in_channels // reduction, kernel_size=(1, 1), stride=(1, 1), padding=(0, 0), bias=True)
        self.relu1 = Activation(act_type='relu', inplace=True)
        self.conv2 = nn.Conv2d(in_channels=in_channels // reduction, out_channels=in_channels, kernel_size=(1, 1), stride=(1, 1), padding=(0, 0), bias=True)
...
class MobileNetV3(nn.Module):
    def __init__(self, in_channels=3, model_name='large', scale=0.5, disable_se=True, **kwargs):
